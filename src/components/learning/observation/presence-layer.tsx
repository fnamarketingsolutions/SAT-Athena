          ...
          <AnimatePresence mode="wait">
            {showCaption && (
              <motion.div
                ...
                className={`max-w-[360px] rounded-lg border border-border bg-card px-4 py-2 ${capAbove ? "text-left" : "text-right"} text-base leading-snug text-foreground shadow-sm`}
              >
