  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h1 className="text-3xl font-bold text-foreground mb-2">Welcome to Studio</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link
              href="/studio/lesson"
              className="group p-8 rounded-2xl border border-border bg-card hover:border-primary/50 transition-all duration-200"
            >
              ...
              <h2 className="text-xl font-semibold text-foreground mb-2">Start a Lesson</h2>
            ...
            {isAdmin && (
              ...
              >
                ...
                <p className="text-muted-foreground text-sm">
                  User ops, agent config, and internal tooling — admins only.
                </p>
              </Link>
            )}
            ...
            >
              ...
              <h2 className="text-xl font-semibold text-foreground mb-2">Session History</h2>
              <p className="text-muted-foreground text-sm">
