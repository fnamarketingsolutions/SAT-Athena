            ...
            <AnimatePresence mode="wait">
              {caption && (
                <motion.div
                  ...
                  className="max-w-[min(640px,calc(100vw-2rem))] rounded-lg border border-border bg-card px-4 py-2 text-center text-base leading-snug text-foreground shadow-sm"
                >
